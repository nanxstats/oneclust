...
For sequential data, the algorithm might be useful for peak calling and segmentation.
...
## Clustering while preserving data order (k = 6)

To find a segmentation of the data, we should respect the order of the data:
